...
namespace TheEpicRoles.Patches 
{
    ...
    public static class ClientOptionsPatch
    {
        private static SelectionBehaviour[] AllOptions = {
            new SelectionBehaviour("Режим Стримера", () => TheEpicRolesPlugin.StreamerMode.Value = !TheEpicRolesPlugin.StreamerMode.Value, TheEpicRolesPlugin.StreamerMode.Value),
            new SelectionBehaviour("Призраки Видят Выполненные Задания", () => MapOptions.ghostsSeeTasks = TheEpicRolesPlugin.GhostsSeeTasks.Value = !TheEpicRolesPlugin.GhostsSeeTasks.Value, TheEpicRolesPlugin.GhostsSeeTasks.Value),
            new SelectionBehaviour("Призраки Видят Голоса", () => MapOptions.ghostsSeeVotes = TheEpicRolesPlugin.GhostsSeeVotes.Value = !TheEpicRolesPlugin.GhostsSeeVotes.Value, TheEpicRolesPlugin.GhostsSeeVotes.Value),
            new SelectionBehaviour("Призраки Видят Роли", () => MapOptions.ghostsSeeRoles = TheEpicRolesPlugin.GhostsSeeRoles.Value = !TheEpicRolesPlugin.GhostsSeeRoles.Value, TheEpicRolesPlugin.GhostsSeeRoles.Value),
            new SelectionBehaviour("Показывать Итоги Ролей", () => MapOptions.showRoleSummary = TheEpicRolesPlugin.ShowRoleSummary.Value = !TheEpicRolesPlugin.ShowRoleSummary.Value, TheEpicRolesPlugin.ShowRoleSummary.Value),
            new SelectionBehaviour("Показывать Светлый/Темный", () => MapOptions.showLighterDarker = TheEpicRolesPlugin.ShowLighterDarker.Value = !TheEpicRolesPlugin.ShowLighterDarker.Value, TheEpicRolesPlugin.ShowLighterDarker.Value),
            new SelectionBehaviour("Улучшенный Курсор", () => MapOptions.toggleCursor = TheEpicRolesPlugin.ToggleCursor.Value = !TheEpicRolesPlugin.ToggleCursor.Value, TheEpicRolesPlugin.ToggleCursor.Value),
        };
