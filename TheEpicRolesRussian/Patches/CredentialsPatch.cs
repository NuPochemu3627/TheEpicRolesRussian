...
namespace TheEpicRoles.Patches {
    ...
    public static class CredentialsPatch {
        ...
        public static string fullCredentials        = $"<size=130%><color={terColor}>The Epic Roles Russian</color></size> <size=50%>v{TheEpicRolesPlugin.Version.ToString()}\nRemodded by <color={terColor}>LaicosVK</color>, <color={terColor}>Nova</color> & <color={terColor}>DasMonschta</color>\nGraphics by <color={terColor}>moep424</color>\nTranslation by <color={terColor}>Нупочему?#3627</color>, <color={terColor}>Aspirata</color>";
